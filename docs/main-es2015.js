...
ArtistaComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"], _services_spotify_service__WEBPACK_IMPORTED_MODULE_3__["SpotifyService"]])
], ArtistaComponent);
...
let SpotifyService = class SpotifyService {
    ...
    getCancionesArtista(idArtista) {
        return this.getQuery(`artists/${idArtista}/top-tracks?country=es`)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])((data) => data.tracks));
    }
};
...
module.exports = __webpack_require__(/*! D:\Programas\Wamp\www\Angular\SpotiAngular\src\main.ts */"./src/main.ts");
